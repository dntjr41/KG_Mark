...
parser.add_argument('--output_path', type=str, help='JSONL path to save output data.', default="/home/wooseok/PostMark-main/outputs/test/test_postmark.jsonl")

parser.add_argument('--llm', type=str, help='The base LLM to watermark the outputs of.', choices=["gpt-4", "llama-3-8b", "llama-3-8b-chat", "mistral-7b-inst"], default="llama-3-8b-chat")
...
parser.add_argument('--inserter', type=str, help='The LLM for inserting watermark words.', choices=["gpt-4o", "llama-3-70b-chat"], default="llama-3-70b-chat")
...
parser.add_argument('--paraphraser', type=str, help='Which paraphraser model to use.', choices=["gpt-3.5-turbo", "gpt-4o", "dipper"], default="dipper")
...
for idx, dd in tqdm.tqdm(enumerate(input_data)):
    ...
    append_to_output_file(output_path, res)
